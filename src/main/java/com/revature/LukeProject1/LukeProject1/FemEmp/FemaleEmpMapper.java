...
public class FemaleEmpMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
	...
	public void map(LongWritable key, Text value, Context context)
		...
		// Represents the percentage of females employed in that particular country
		if (!line.contains("SL.EMP.TOTL.SP.FE.NE.ZS")) {
			return;
		}
